...
* 目的：個人開発における判断基準・設計方針・運用ルールを示し、再現可能な形で意思決定を残すためのガイドラインです。  
* 対象：技術者や協力者で、私がどのように開発しているかの参考情報を求めている人。

このセクションは "私が開発でどのように判断し、どう取り組んでいるか" を紹介するものです。  
GitHub の使い方、コーディング・設計方針、プロジェクト運営方針などを含みます。

***ベストプラクティスの提示ではなく、参考情報*** です。  
